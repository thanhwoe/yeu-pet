    ...
    >
      ...
      >
        ...
        <View className="flex-row flex-wrap gap-10 mb-14">
          <DetailItem label="Gender" value={pet.gender} color={theme.detail} />
          <DetailItem
            label="Birthdate"
...
const DetailItem = ({
  ...
  <View className={cn("w-[48%] bg-pink-10 rounded-12 p-10", color)}>
    <Body variant="body5" weight="semiBold" caps className="mb-14 text-black">
      {label}
    </Body>
    <Body
      variant="body3"
