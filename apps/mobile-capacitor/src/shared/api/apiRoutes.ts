/**
 * API routes — keep in sync with apps/mobile/constants/api-routes.ts
 */
export const API_ROUTES = {
  ...
  // Sitter booking (backend: apps/api/src/modules/sitter-bookings, pet-sitters)
  SITTERS: "/sitters",
  SITTERS_REGISTER: "/sitters/register",
  SITTER_ME: "/sitters/me",
  SITTER_DETAIL: (id: string) => `/sitters/${id}`,
  SITTER_BOOKINGS: "/sitter-bookings",
  SITTER_BOOKINGS_AS_SITTER: "/sitter-bookings/sitter",
  SITTER_BOOKING_DETAIL: (id: string) => `/sitter-bookings/${id}`,
  SITTER_BOOKING_CONFIRM: (id: string) => `/sitter-bookings/${id}/confirm`,
  SITTER_BOOKING_REJECT: (id: string) => `/sitter-bookings/${id}/reject`,
  SITTER_BOOKING_COMPLETE: (id: string) => `/sitter-bookings/${id}/complete`,
  SITTER_BOOKING_CANCEL: (id: string) => `/sitter-bookings/${id}/cancel`,
  SITTER_REVIEWS: (sitterId: string) => `/sitter-reviews/${sitterId}`,
} as const;
